    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // 第一个： scaleX 从 0 到 1
                PropertyValuesHolder holder1 = PropertyValuesHolder.ofFloat(View.SCALE_X, 0,1);
                // 第二个： scaleY 从 0 到 1
                PropertyValuesHolder holder2 = PropertyValuesHolder.ofFloat(View.SCALE_Y, 0, 1);
                // 第三个： alpha 从 0 到 1
                PropertyValuesHolder holder3 = PropertyValuesHolder.ofFloat(View.ALPHA, 0, 1);
